...
# IDEA
# _C.MODEL.USE_Prototype = True
_C.MODEL.USE_Prototype = False

# _C.MODEL.USE_BACKGROUND = True
_C.MODEL.USE_BACKGROUND = False
_C.MODEL.BACKGROUND_ALIGN_LOSS_WEIGHT = 0.1


# _C.MODEL.USE_ISA = True
_C.MODEL.USE_ISA = False # 根据回归偏移的长宽比

# 使用自注意力和跨注意力
# _C.MODEL.USE_CROSS_SELF_ATTENTION = True
_C.MODEL.USE_CROSS_SELF_ATTENTION = False

############################################################################################################################
_C.MODEL.USE_Prototype_FUSE = False

_C.MODEL.MultiHH = True
# -----------------------------------------------------------------------------
...
_C.MODEL.RPN.RETURN_FUSED_FEATURES = True # 2025.03.26修改为true，为了计算CKA
...
############################################################################
# 尝试给body（语言、文本）设置更大或者更小的学习率
_C.SOLVER.BACKBONE_BODY_LR_FACTOR = 0.1
############################################################################
...
# _C.SOLVER.GAMMA = 0.1 # 默认的参数
#########################################################
_C.SOLVER.GAMMA = 0.01
